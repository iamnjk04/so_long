...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/29 23:17:26 by nakunwar          #+#    #+#             */
/*   Updated: 2025/07/08 20:24:31 by nakunwar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	write_move_count(t_main *main)
{
	...
	mlx_string_put(main->mlx, main->win, (PIXEL * 4), PIXEL / 2, c, "C U P:");
	str2 = ft_itoa(main->cup_count);
...
static int	draw_map2(t_main *main, int y, int x)
{
	...
	else if (main->map->map[y][x] == 'P')
	{
		...
		mlx_put_image_to_window(main->mlx, main->win, main->img->cup, x, y);
